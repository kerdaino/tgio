...
const testimonies = [
  {
    ...
    title: "A Story of God’s Faithfulness",
    image: "/images/prayer-gathering.jpg",
    story:
      "We believe testimonies are powerful reminders of God’s goodness, faithfulness, and ability to intervene in every area of life. Real testimonies shared by members of this community will appear here as they are submitted and reviewed.",
    name: "Shared Testimony",
    meta: "Prayer & Faith",
  },
  {
    id: "2",
    category: "Spiritual Growth",
    title: "Growing Through the Word",
    image: "/images/bible-study.jpg",
    story:
      "This space is being prepared to highlight real stories of spiritual growth, deeper understanding of Scripture, renewed faith, and lives strengthened through fellowship, prayer, and Bible study.",
    name: "Coming Soon",
    meta: "Bible Study & Fellowship",
  },
  {
    id: "3",
    ...
    story:
      "As outreach updates and real testimonies are shared, this page will reflect the practical ways God is moving through evangelism, service, compassion, and community impact.",
    name: "Community Story",
    meta: "Outreach & Service",
  },
  {
    id: "4",
    category: "Encouragement",
    title: "Hope for Every Season",
    image: "/images/bible-prayer.jpg",
    story:
      "Testimonies encourage faith, strengthen hearts, and remind believers that God is still at work. This section will continue to grow as more real stories are shared through the ministry.",
    name: "Encouragement",
    meta: "Faith Journey",
  },
]
      ...
      <section className="bg-background pt-12">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          <p className="leading-relaxed text-muted-foreground">
            Real testimonies submitted through the ministry will be reviewed and published here
            to encourage others and glorify God.
          </p>
        </div>
      </section>
            ...
            {testimonies.map((testimony) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="mb-6 text-sm leading-relaxed text-foreground line-clamp-5">
                    {testimony.story}
                  </p>

                  <div className="border-t border-border pt-4">
                    <p className="text-sm font-semibold text-foreground">{testimony.name}</p>
                    <p className="text-xs text-muted-foreground">{testimony.meta}</p>
                  </div>
                </div>
              </article>
            ))}
