      ...
      <section className="bg-background pt-10">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          <p className="leading-relaxed text-muted-foreground">
            Browse memorable moments from fellowship meetings, prayer sessions,
            Bible study gatherings, outreach activities, and ministry highlights.
          </p>
        </div>
      </section>
          ...
          {filtered.length === 0 ? (
            <div className="rounded-3xl border border-dashed border-border bg-card px-6 py-16 text-center">
              ...
              <p className="mx-auto mt-3 max-w-xl leading-relaxed text-muted-foreground">
                Photos and videos will appear here as they are uploaded.
              </p>
            </div>
          ) : (
              ...
              {filtered.map((item, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-4 opacity-0 transition-opacity group-hover:opacity-100">
                    <p className="text-sm font-medium text-white">{item.title || item.alt}</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm">
          ...
          <div className="mx-4 w-full max-w-5xl">
            ...
            <div className="mt-4 text-center">
              <p className="text-sm font-medium text-white">{activeItem.title || activeItem.alt}</p>
