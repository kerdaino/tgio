...
/**
 * This object should later come from admin settings / database
 */
const donationAccounts: Record<CurrencyCode, AccountDetails> = {
  NGN: {
    bankName: "Admin Update Required",
    accountName: "The Good Ones International Outreach",
    accountNumber: "0000000000",
    note: "Please update the NGN account details from the admin dashboard.",
  },
  USD: {
    bankName: "Admin Update Required",
    accountName: "The Good Ones International Outreach",
    accountNumber: "USD-ACCOUNT-DETAILS",
    note: "Please update the USD account details from the admin dashboard.",
  },
  EUR: {
    bankName: "Admin Update Required",
    accountName: "The Good Ones International Outreach",
    accountNumber: "EUR-ACCOUNT-DETAILS",
    note: "Please update the EUR account details from the admin dashboard.",
  },
  GBP: {
    bankName: "Admin Update Required",
    accountName: "The Good Ones International Outreach",
    accountNumber: "GBP-ACCOUNT-DETAILS",
    note: "Please update the GBP account details from the admin dashboard.",
  },
}
...
export default function DonatePage() {
  ...
  const activeAccount = donationAccounts[formData.currency]
              ...
              {submitted ? (
                <div className="rounded-2xl border border-border bg-card p-8 text-center">
                  ...
                  <p className="mx-auto max-w-md leading-relaxed text-muted-foreground">
                    Your donation intention has been submitted successfully.
                    We appreciate your generosity and support toward the mission.
                  </p>
                ...
                <>
                  ...
                  <p className="mt-4 leading-relaxed text-muted-foreground">
                    ...
                    using the account details below, then submit your payment reference.
                  </p>
                    ...
                    <div className="space-y-5">
                      ...
                      <div>
                        ...
                        <div className="mt-1 flex items-center justify-between gap-3">
                          <p className="text-lg font-semibold text-foreground">{activeAccount.bankName}</p>
                          <button
                            type="button"
                            onClick={() => copyText(activeAccount.bankName, "bank")}
                      ...
                      <div>
                        ...
                        <div className="mt-1 flex items-center justify-between gap-3">
                          <p className="text-lg font-semibold text-foreground">{activeAccount.accountName}</p>
                          <button
                            type="button"
                            onClick={() => copyText(activeAccount.accountName, "account-name")}
                            className="inline-flex items-center gap-1 rounded-lg border border-border px-3 py-2 text-xs font-medium text-foreground hover:bg-secondary"
                          >
                            <Copy className="h-4 w-4" />
                      ...
                      <div>
                        ...
                        <div className="mt-1 flex items-center justify-between gap-3">
                          ...
                          <button
                            type="button"
                            onClick={() => copyText(activeAccount.accountNumber, "account-number")}
                            className="inline-flex items-center gap-1 rounded-lg border border-border px-3 py-2 text-xs font-medium text-foreground hover:bg-secondary"
                          >
                            <Copy className="h-4 w-4" />
                  ...
                  <form onSubmit={handleFinalSubmit} className="mt-8 flex flex-col gap-5">
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        required
                        placeholder="Enter your transfer reference or note"
                        className="w-full rounded-xl border border-border bg-card px-4 py-3 text-foreground placeholder:text-muted-foreground focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/40"
                      />
                    </div>
